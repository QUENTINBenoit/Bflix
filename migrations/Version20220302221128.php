 ...
 */
final class Version20220302221128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tvshow ADD poster VARCHAR(255) DEFAULT NULL');
    }
